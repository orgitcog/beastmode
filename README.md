...
[![Deploy Beast Mode WebVM](https://github.com/orgitcog/beastmode/actions/workflows/deploy.yml/badge.svg)](https://github.com/orgitcog/beastmode/actions/workflows/deploy.yml)
[![Based on WebVM](https://img.shields.io/badge/Based%20on-WebVM-blue)](https://github.com/leaningtech/webvm)

**Beast Mode** is a browser-based Linux virtual machine powered by [WebVM](https://github.com/leaningtech/webvm), pre-configured with the **MS Graph & GitHub Enterprise Automation Toolkit**.

## Beast Mode Features

- **Browser-Based Linux VM**: Full Linux environment running entirely in your browser using WebAssembly
- **MS Graph Integration**: Python toolkit for Microsoft Graph API automation
- **GitHub Enterprise Support**: Scripts for managing GitHub Enterprise organizations and teams
- **Org Synchronization**: Tools for syncing organizations between Azure AD and GitHub Enterprise
- **Zero Installation**: No software installation required - runs directly in your browser

## Quick Start with Beast Mode

Once deployed, use these commands in the WebVM terminal:
...
beastmode config --init

# List Azure AD users
beastmode users --source azure
```
...
The following documentation is from the original WebVM project.
